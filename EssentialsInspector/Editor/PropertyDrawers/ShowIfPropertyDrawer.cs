...
namespace Essentials.Inspector
{
    ...
    public class ShowIfPropertyDrawer : PropertyDrawer
    {
            ...
            switch (condition.propertyType)
            {
                case SerializedPropertyType.Integer:
                    ...
                    else if (showIfAttribute.compareValue is string)
                    {
                        ...
                        string operation = GetOperationFromString(showIfAttribute.compareValue.ToString());
                ...
                case SerializedPropertyType.Float:
                    ...
                    else if (showIfAttribute.compareValue is string)
                    {
                        ...
                        string operation = GetOperationFromString(showIfAttribute.compareValue.ToString());
                        string pureFloat = GetPureFloat(showIfAttribute.compareValue.ToString());
                        ...
                        foreach (object valueObj in showIfAttribute.compareValues)
                        {
                            switch (valueObj)
                            {
                                ...
                                case int obj:
                                    values.Add(obj);
                                    break;
                                case string _ when float.TryParse(GetPureFloat(valueObj.ToString()), NumberStyles.Float, CultureInfo.InvariantCulture, out float value):
                                    values.Add(value);
                                    break;
                                default:
                                    DisplayError(position, ErrorType.InvalidFloat);
        ...
        private string GetOperationFromString(string s)
        {
