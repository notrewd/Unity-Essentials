...
{
    /// <summary>
    /// Attribute to conditionally enable a field in the inspector based on the value of another field.
    /// </summary>
    public class EnableIfAttribute : PropertyAttribute
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnableIfAttribute"/> class.
        /// Enables the field if the condition field's value equals the compare value.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnableIfAttribute"/> class.
        /// Enables the field if the condition field's value equals any of the compare values (using CompareType.All by default).
        /// </summary>
        /// <param name="conditionName">The name of the field to check the condition against.</param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnableIfAttribute"/> class.
        /// Enables the field based on the comparison type (All or Any) against the compare values.
        /// </summary>
        /// <param name="conditionName">The name of the field to check the condition against.</param>
